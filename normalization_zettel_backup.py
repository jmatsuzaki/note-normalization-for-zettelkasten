...
EXCLUDE_DIR = set(
    ["Backup", "Template", "tmp", "node_modules"]
...
if __name__ == "__main__":
    ...
    if os.path.isdir(args.root):
        ...
        logger.info(
            "Set the specified folder as the root folder of Zettelkasten and process all files under it"
        )
        ROOT_PATH = args.root
    else:
    ...
    if args.target:
        ...
        if os.path.exists(TARGET_PATH):
            ...
            logger.critical(
                "The specified target folder or file does not seem to exist."
            )
            logger.critical("Abort the process")
            sys.exit()
    else:
    ...
    if args.yes:
        logger.info(
            "--yes option has been specified, continue processing automatically"
        )
    else:
    ...
    logger.info(
        "The execution log was saved to a log file. please see /path/to/your/zettelkasten_root_folder/normalization_zettel.log files."
    )
    logger.info("=================================================")
